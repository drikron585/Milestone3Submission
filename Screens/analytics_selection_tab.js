...
export default function Analytics_Select({ navigation }){
    return(
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                {   
                    jsondata.map((currentObject, i) => (
                        <ListItem key={i} bottomDivider>
                            <ListItem.Title onPress = {() => navigation.navigate('exercise_analytics_tab',currentObject.excercise1)}>{
                ...
                }
                {
                    jsondata.map((currentObject, i) => (
                        <ListItem key={i} bottomDivider>
                            <ListItem.Title onPress = {() => navigation.navigate('exercise_analytics_tab',currentObject.excercise2)}>{
                ...
                }
                {
                    jsondata.map((currentObject, i) => (
                        <ListItem key={i} bottomDivider>
                            <ListItem.Title onPress = {() => navigation.navigate('exercise_analytics_tab',currentObject.excercise3)}>{
