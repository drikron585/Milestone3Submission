...
export default function workout_start1({ navigation }){

    return(
        <SafeAreaView style={styles.container}>
                <Text style={styles.dateBar}>
                    <Text>{navigation.getParam('workoutName')}      1/3</Text>
                    {"\n"}
                </Text>
                <Text style={styles.titleBar}>
                    <Text>{navigation.getParam('excName1')}</Text>
                    {"\n"}
                </Text>
            ...
            <XBar style={styles.workoutBar}
                slots={[
                    { 
                        children : <Text style={styles.workoutText}>{"\n"}    {navigation.getParam('excWeight1')} (lb)</Text>,
                    },
                    { 
                        children : <Text style={styles.workoutText}>{"\n"}    {navigation.getParam('excRep1')} (reps)</Text>,
                    },
                    {
            ...
            <Button style={styles.nextButton}
                    ...
                    onPress = {
                        () =>{
                                ...
                                navigation.navigate('workout_start2',List);
                            } 
